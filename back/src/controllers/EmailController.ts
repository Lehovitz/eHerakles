        ...
        async sendPayment(req: Request, res: Response){
            ...
            var mailOptions = {
              ...
              html: `<h1>Hello ${person.name} ${person.surname} </h1>
                    ...
                    <p>The amount due is: <b>${payment.due}</b> </p>
        ...
        async sendReminder(req: Request, res: Response){
          ...
          var mailOptions = {
            ...
            html: `<h1>Hello ${person.name} ${person.surname} </h1>
                  ...
                  <p>Remember to extend your pass! It is valid to: <b>${DateTransformation(new Date(expDate))}</b></p>
                  <p>Your subscribtion due is: <b>${card.due}</b></p>
                  <p>To extend your card send your payment before: <b>${DateTransformation(new Date(expDate))}</b></p>
