  ...
  return (
    <>
      ...
      {role !== "none" ? (
        <>
          ...
          {!["moderator", "admin"].includes(role) && (
            <>
              ...
              <Link className={linkClass} to="cards" onClick={closeDrawer}>
                <Button className={buttonClass} color="inherit">
                  Card
                </Button>
              </Link>
          ...
          {["moderator", "admin"].includes(role) && (
            <>
              <Link className={linkClass} to="admin" onClick={closeDrawer}>
                <Button className={buttonClass} color="inherit">
                  Admin
                </Button>
              </Link>
        ...
        <Link className={linkClass} to="/" onClick={closeDrawer}>
          <Button className={buttonClass} color="inherit">
            Login
          </Button>
        </Link>
